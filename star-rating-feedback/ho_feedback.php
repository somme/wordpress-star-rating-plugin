...
<div class="wrap">
   ...
   <div class="feedback-row">
               <div class="feedback-row-button"><input type="submit" value="Delete all messages" class="button button-secondary"></div>
</div>
              </div>
                ...
                if ($comments != null)
                {
                    ...
                    foreach ($comments as $comment)
                    {
                        ...
                        getStars($rating);
                  			...
                  			echo "<td scope='col'>";
                  			xecho ($date_added);
                  			echo "</td><td><a href='#' class='btn'><i class='fa fa-trash-o'>";
                        echo "</i></a></td></tr>";
                    }
                }
...
//To DO: dynamic based on amount of stars
